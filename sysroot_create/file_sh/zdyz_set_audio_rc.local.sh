...
audio_input() {
	...
	amixer sset 'Left Input Boost Mixer LINPUT1' 0 # 0 - 3
	...
	# 咪头 LINE_INL
	amixer sset 'Right Boost Mixer RINPUT2' on      # 只打开 该声道 音频输入
	amixer sset 'Right Input Boost Mixer RINPUT2' 7 # 7 [100%] [6.00dB]

	# 耳机 AUD_INT
	amixer sset 'Right Boost Mixer RINPUT3' on      # 只打开 该声道 音频输入
	amixer sset 'Right Input Boost Mixer RINPUT3' 7 # 7 [100%] [6.00dB]
}
