...
audio_input() {
	...
	# 关闭 左/右 声道 音频输入，只打开 RINPUT3 音频输入
	...
	# 咪头 LINE_INL 
	${Sudo} amixer sset 'Right Boost Mixer RINPUT2' off &>>"${Output_log}"
	${Sudo} amixer sset 'Right Input Boost Mixer RINPUT2' 0 &>>"${Output_log}" # 0 - 7 
	# 耳机 AUD_INT 
