...
Opt_arm_xorgproto=/opt/arm_xorgproto # 编译输出路径

func_execute_sudo rm -rf ${Opt_arm_xorgproto}
func_mkdir 777 ${Opt_arm_xorgproto}
...
func_chmod 777 ${Opt_arm_xorgproto}
