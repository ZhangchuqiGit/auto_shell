...
Opt_arm_libxcbu=/opt/arm_libxcb # 编译输出路径

func_execute_sudo rm -rf ${Opt_arm_libxcbu}
func_mkdir 777 ${Opt_arm_libxcbu}

Opt_arm_xcb_proto=/opt/arm_xcb-proto
func_path_isexit "Opt_arm_xcb_proto" ${Opt_arm_xcb_proto}

Opt_arm_libXau=/opt/arm_libXau
func_path_isexit "Opt_arm_libXau" ${Opt_arm_libXau}
...
export LDFLAGS="-L${Opt_arm_xcb_proto}/lib -L${Opt_arm_libXau}/lib"
export CFLAGS="-I${Opt_arm_libXau}/include"
# export CFLAGS="-I${Opt_arm_libXau}/include -I${Opt_arm_xorgproto}/include"
...
func_chmod 777 ${Opt_arm_libxcbu}
