...
func_apt -p universe
func_apt -i vim vim-* vpnc vpnc-* axel rsync openssh-server unrar unrar* p7zip-full p7zip-rar rar zip zip*
sudo apt-get update --fix-missing
func_apt -i python3 python3.7 python3.8 python3.7* python3.8* kchmviewer tree python python2 gedit gedit*
sudo apt-get update --fix-missing
func_apt -i net-tools ubuntu-mobile-icons ubuntu-release-upgrader*
func_apt -i ubuntu-settings ubuntu-wallpape* rpm http*
func_apt -i libsctp-dev lksctp-tools
